...
The application is running on (https://rb.gy/v3utyw)

ui.R, and Server.R Code in my github repository (https://github.com/bulahuang/Course-Project-Shiny-Application-and-Reproducible-Pitch)
